# 🇮🇳 Bharat Browser (`bharat-browser`) - v1.1.1

> **Modern, Ultra-Fast, and Privacy-First Web Browser engineered for Linux (Ubuntu)**

[![Version](https://img.shields.io/badge/version-1.1.1-blue.svg)](https://github.com/Sangam1112/bharat-browser)
...
sudo dpkg -i bharat-browser_1.1.1_amd64.deb
...
The resulting package will be generated at `./bharat-browser_1.1.1_amd64.deb`.
