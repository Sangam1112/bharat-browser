# 🇮🇳 Bharat Browser (`bharat-browser`) - v1.0.7

> **Modern, Ultra-Fast, and Privacy-First Web Browser engineered for Linux (Ubuntu)**

[![Version](https://img.shields.io/badge/version-1.0.7-blue.svg)](https://github.com/Sangam1112/bharat-browser)
...
sudo dpkg -i bharat-browser_1.0.7_amd64.deb
...
The resulting package will be generated at `./bharat-browser_1.0.7_amd64.deb`.
